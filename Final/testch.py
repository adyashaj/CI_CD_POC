...
print("adding gerrit-trigger in jenkins")
...
gerrit = """sudo chown jenkins:jenkins gerrit-trigger.xml"""
os.system(gerrit)

chmod = """sudo chmod 777 gerrit-trigger.xml"""
os.system(chmod)

cmd="sudo docker exec -i %s  sh -c 'cat > /var/jenkins_home/gerrit-trigger.xml'< ./gerrit-trigger.xml"% (jenkinsHostName)
os.system(cmd)
#cmd="docker exec -i demo_jenkins sh -c 'cat > /var/jenkins_home/gerrit-trigger.xml'< ./gerrit-trigger.xml"
#os.system(cmd)
cmd1="docker restart %s"% (jenkinsHostName)
os.system(cmd1)
#cmd1="docker restart demo_jenkins"
#os.system(cmd1)
print("Successfully added Gerrit-trigger")
